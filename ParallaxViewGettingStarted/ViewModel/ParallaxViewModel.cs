...
namespace ParallaxViewGettingStarted
{
    public class ParallaxViewModel
    {
        ...
        public ParallaxViewModel()
        {
            ...
            Image = ImageSource.FromResource("ParallaxViewGettingStarted.Resources.Images.parallax.jpg", assembly);
            ...
            for (int i = 0; i < Items.Count; i++)
            {
                if (i >= 10)
                {
                    Items[i].ItemImage = ImageSource.FromResource("ParallaxViewGettingStarted.Resources.Images.parallax" + count + ".png", assembly);
                    count++;
                }
                else
                {
                    Items[i].ItemImage = ImageSource.FromResource("ParallaxViewGettingStarted.Resources.Images.parallax" + i + ".png", assembly);
                }
            }
        }
    }
